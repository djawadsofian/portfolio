...
const OrbitingDot: React.FC<OrbitingDotProps> = React.memo(
  ({ index, total }) => {
...
const HeroSection: React.FC = () => {
  ...
  const orbitingDots = useMemo(
    () =>
      Array.from({ length: 6 }, (_, i) => (
        <OrbitingDot key={i} index={i} total={6} />
      )),
    []
  );
  ...
  return (
    <motion.section
      className="min-h-screen h-screen flex items-center justify-center relative overflow-hidden bg-gradient-to-br from-gray-900 via-gray-800 to-black dark:from-gray-950 dark:via-gray-900 dark:to-black"
      style={{ y, opacity }}
    >
        ...
        <div className="grid lg:grid-cols-2 gap-8 lg:gap-12 items-center min-h-[calc(100vh-4rem)]">
          ...
          >
            <div className="space-y-3 lg:space-y-4 mt-10">
              <motion.h1
                className="text-4xl sm:text-5xl lg:text-6xl xl:text-7xl font-bold text-white dark:text-gray-100 leading-tight"
                variants={fadeInUp}
              ...
              <motion.div
                className="text-xl sm:text-2xl lg:text-3xl xl:text-4xl text-gray-200 dark:text-gray-400 font-light"
                variants={fadeInUp}
            ...
            <motion.p
              className="text-lg lg:text-xl text-gray-300 dark:text-gray-500 max-w-2xl"
              variants={fadeInUp}
            ...
            >
              {/* <motion.button
                className="group bg-gradient-to-r from-yellow-400 to-yellow-500 text-black px-6 lg:px-8 py-3 lg:py-4 rounded-full font-semibold flex items-center justify-center space-x-2 hover:from-yellow-500 hover:to-yellow-600 transition-all duration-300 shadow-lg hover:shadow-yellow-500/25"
